    ...
    <div class="Register">
        <div class="contents">
            ...
            <div class="input_box id">
                ...
                <input type="text" id="id" v-model="user_id" placeholder="아이디" :disabled="id_chk"
                    oninput="javascript: this.value = this.value.replace(/[ㄱ-ㅎ|ㅏ-ㅣ|가-힣]/g, '' );">
                <div class="check"><button @click="chk_id_dup" :class="[id_chk ? 'disabled' : 'check_btn']"
                        :disabled="id_chk">중복확인</button></div>
            </div>
