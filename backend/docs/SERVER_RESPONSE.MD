...
> - [RES_BBONG](#res_bbong): 플레이어가 뽕을 했을 경우에 대한 응답 반환
> - [REE_DRAW_BBONG_CARD](#res_draw_bbong_card) : 뽕 로직 처리 후 정보 반환
> - [RES_NATURE](#res_nature): 플레이어가 자연을 했을 경우에 대한 응답 반환
> - [RES_DRAW_NATURE](#res_draw_nature) : 자연 로직 처리 후 정보 반환
